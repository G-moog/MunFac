...
public class MunDTO {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(munType, munDTO.munType) && Objects.equals(munContent, munDTO.munContent) && Objects.equals(choose1Content, munDTO.choose1Content) && Objects.equals(choose2Content, munDTO.choose2Content) && Objects.equals(choose3Content, munDTO.choose3Content) && Objects.equals(choose4Content, munDTO.choose4Content) && Objects.equals(choose5Content, munDTO.choose5Content) && Objects.equals(answer, munDTO.answer) && Objects.equals(useYn, munDTO.useYn);
    }

    @Override
    public int hashCode() {
        return Objects.hash(munType, munContent, choose1Content, choose2Content, choose3Content, choose4Content, choose5Content, answer, useYn);
    }
